...
def test_clean_image_url() -> None:
    ...
    assert clean_image_url(
        image_url="//https://i.imgur.com/1.jpg") == "https://i.imgur.com/1.jpg"
...
def test_extract_image_format():
    ...
    assert extract_image_format(
        image_url="https://i.imgur.com/1.jpg") == "jpeg"
    ...
    assert extract_image_format(
        image_url="https://i.imgur.com/1.webp") == "webp"
    assert extract_image_format(
        image_url="https://i.imgur.com/1.jpeg") == "jpeg"
    with pytest.raises(ValueError):
    ...
    with pytest.raises(ValueError):
        extract_image_format(
            image_url="https://i.imgur.com/asdas/a/1.svg")
